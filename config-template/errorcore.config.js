...
module.exports = {
  ...
  // Fixed capture mode. safe is the low-overhead default; forensic is the
  // richest mode. Use setCaptureMode() at runtime to switch this mode.
  captureMode: 'safe',

  // Adaptive capture starts in safe, escalates to forensic after an admitted
  // capture, and de-escalates after quiet time.
  // adaptiveCapture: {
  //   enabled: true,
  //   base: 'safe',
  //   escalated: 'forensic',
  ...
  // allowInsecureTransport is not supported - use allowPlainHttpTransport instead

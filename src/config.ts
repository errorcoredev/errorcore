...
function warnLegacyInsecureTransportOnce(): void {
  ...
  safeConsole.warn(
    ...
    'Remove it from your config. (Deprecated in 0.1.0, will be removed in 1.0.0.) ' +
...
export function resolveConfig(userConfig: Partial<SDKConfig> = {}): ResolvedConfig {
  ...
  if (legacyInsecureTransport === true) {
    ...
    throw new Error(
      'allowInsecureTransport: true was renamed to allowPlainHttpTransport: true in 0.1.0. ' +
      'Update your config. (Deprecated in 0.1.0, will be removed in 1.0.0.)'
    );
  }

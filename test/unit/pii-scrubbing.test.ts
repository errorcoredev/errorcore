...
describe('Scrubber', () => {
  ...
  it('creates a default scrubber for backend parity consumers', () => {
    const scrubber = createDefaultPiiScrubber();

    expect(scrubber.scrubObject({
